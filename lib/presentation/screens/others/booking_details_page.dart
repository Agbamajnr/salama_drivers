        ...
        body: StreamBuilder<List<Booking>?>(
            ...
            builder: (context, snapshot) {
              if (snapshot.data == null) {
                ...
                final booking = item ?? widget.params.booking;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      booking.startTime == null
                          ? Container()
                          : containerRow('Ride Start', booking.startTime ?? ""),
                      booking.endTime == null
                          ? Container()
                          : containerRow('Ride', booking.endTime ?? ""),
                      containerRow(
                        'Booking Time',
